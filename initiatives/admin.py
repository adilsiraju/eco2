...
class InitiativeAdmin(admin.ModelAdmin):
    ...
    filter_horizontal = ('categories',)  # Adds a nice widget for ManyToManyField

@admin.register(Company)
class CompanyAdmin(admin.ModelAdmin):
    list_display = ('name', 'status', 'total_shares', 'shares_sold', 'share_price', 'duration_months', 'company_scale', 'location', 'technology_type')
    list_filter = ('status', 'categories', 'location', 'technology_type')
