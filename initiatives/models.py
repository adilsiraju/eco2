...
class Initiative(models.Model):
    ...
    LOCATION_CHOICES = [
        ('North India', 'North India'),  # e.g., arid, industrial
        ('South India', 'South India'),  # e.g., tropical, coastal
        ('East India', 'East India'),    # e.g., humid, rural
        ('West India', 'West India'),    # e.g., semi-arid, urban
    ]
    TECHNOLOGY_CHOICES = [
        ('Solar', 'Solar'),
        ('Wind', 'Wind'),
